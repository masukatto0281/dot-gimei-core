...
namespace DotGimei
{
    ...
    public static class Gimei
    {
        ...
        public class Generator
        {
            ...
            /// addresses:
            ///   prefecture:
            ///     - ['群馬県', 'ぐんまけん', 'グンマケン', 'Gummaken']
            ///     - ['長野県', 'ながのけん', 'ナガノケン', 'Naganoken']
            ///   city:
            ///     - ['山本郡藤里町', 'やまもとぐんふじさとまち', 'ヤマモトグンフジサトマチ', 'Yamamotogunfujisatomachi']
            ///     - ['遠賀郡岡垣町', 'おんがぐんおかがきまち', 'オンガグンオカガキマチ', 'Ongagunokagakimachi']
            ///   town:
            ///     - ['吾妻橋', 'あづまばし', 'アヅマバシ', 'Adumabashi']
            ///     - ['米山町愛宕前', 'よねやまちょうあたごまえ', 'ヨネヤマチョウアタゴマエ', 'Yoneyamachouatagomae']
            ///     - ['宇目河内', 'うめかわち', 'ウメカワチ', 'Umekawachi']
            /// </code>
            /// <para>
